...
const StyledLink = classed(NavLink, "", {
  variants: {
    variant: {
      primary:
        "px-2.5 py-1 focus-visible:outline-black focus-visible:outline-2 text-black-fogra-29 focus-visible:outline-offset-4 md:focus-visible:outline-offset-8 hover:focus:no-underline",
