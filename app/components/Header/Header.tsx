  ...
  return (
    <div className="relative mt-3 flex flex-col items-center justify-center pb-3 pt-1 text-center md:mt-12">
      ...
      <Link className="group relative" to="/">
        <h1 className="bg-clip-text-safari force-3d inline bg-rich-black-fogra29 font-questrial text-4xl tracking-widest text-transparent transition-all duration-3000 hover:bg-rich-black-fogra29/55 md:text-5xl">
